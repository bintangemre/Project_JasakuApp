...
import { getAllCategories, getCategoriesById, getProvidersByService, getServiceOptions, getServicePricingUnits, getProvidersByServiceWithoutDistance, searchServices } from "./services.controller";
...
router.get('/services/:serviceId/data', authenticate, isCustomer, getServicePricingUnits);
