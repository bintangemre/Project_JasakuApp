...
// Custom Tasks
router.get('/tasks/pending', authenticate, isAdmin, getPendingTasks);
router.patch('/tasks/:taskId/confirm', authenticate, isAdmin, confirmTask);
// Reports
