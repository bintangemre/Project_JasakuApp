...
import { getAvailableServices, getAvailablePricingTypes, postProviderService, getProviderServices, updateProviderService } from './services.controller';
const router = Router();
...
router.post('/services/add-service', authenticate, postProviderService);
